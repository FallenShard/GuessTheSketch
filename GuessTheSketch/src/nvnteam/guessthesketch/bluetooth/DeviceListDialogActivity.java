...
public class DeviceListDialogActivity extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        m_pairedDevicesArrayAdapter = new DeviceListAdapter(this, R.layout.device_name);
        m_newDevicesArrayAdapter = new DeviceListAdapter(this, R.layout.device_name);
        ...
        if (pairedDevices.size() > 0)
        {
            ...
            findViewById(R.id.title_paired_devices_underline).setVisibility(View.VISIBLE);
        ...
        TextView title = (TextView)findViewById(R.id.title_paired_devices);
        TextView newTitle = (TextView)findViewById(R.id.title_new_devices);
        newTitle.setTypeface(tf);
    ...
    private void doDiscovery()
    {
        ...
        findViewById(R.id.title_new_devices_underline).setVisibility(View.VISIBLE);
        ...
        ((Button) findViewById(R.id.button_scan)).setText("Scanning");
    ...
    private OnItemClickListener m_deviceClickListener = new OnItemClickListener()
    {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3)
        {
            ...
            if (info.compareTo("No devices found") == 0)
                return;
    ...
    private final BroadcastReceiver m_receiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            else if (BluetoothAdapter.ACTION_DISCOVERY_FINISHED.equals(action))
            {
                ...
                ((Button) findViewById(R.id.button_scan)).setText("Scan Devices");
